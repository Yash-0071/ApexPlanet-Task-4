...
function showEducationDetails(education) {
    ...
    if (education === "B.Tech") {
        ...
        educationDescription.textContent =
            "Completed My Inter in the Year 2022 from Sri Chaitanya Junior College Visakhapatnam. I have Scored in my Inter 896 marks out of 1000 After Completing my Inter I am entering into B.Tech.in the branch CSD.";
    }
